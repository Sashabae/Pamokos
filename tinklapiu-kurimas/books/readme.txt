...
Vartotojų modelis/lentelė (autorizacijai):
...
Užklausose apie knygas (GET /books ir GET /books/:id) turi būti grąžinama knygos informacija, su pilna autoriaus informacija. ** 2 taškai ** -Užklausose apie autorius (GET /authors ir GET /authors/:id) turi būti grąžinama autoriaus informacija, su jo knygų sąrašu. ** 2 taškai **
